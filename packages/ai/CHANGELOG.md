...
- Added `ModelsStoreEntry.otherModels` for non-chat models, keeping `models` chat-only for existing store readers. Stored and fetched models of unknown types are dropped instead of failing a refresh.
